package com.skilly.bigdata.usercf.step4;
...
public class MR4 {
    ...
    //输入相对路径
    private static String inPath = "/usercf_output2";
    //输出相对路径
    private static String outPath = "/usercf_output4";
    //将step1输出的转置矩阵作为全局缓存
    private static String cache = "/usercf_output3/part-r-00000";
