...
public class MR2 {
    ...
    //输入相对路径
    private static String inPath = "/contentcf_input2";
    //输出相对路径
    private static String outPath = "/contentcf_output2";
    //将step1输出的转置矩阵作为全局缓存
    private static String cache = "/contentcf_output1/part-r-00000";
